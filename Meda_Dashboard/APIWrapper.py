...
class APIwrapper:
    ...
    _last_access=0.0 # time of last api access #DO NOT TOUCH
    ...
    def get_page(self, filters={}, page_size=5):
        ...
        curr_time=time.time() # Unix time: number of seconds since the Epoch # do not touch
        deltat=curr_time-APIwrapper._last_access # do not touch 
        if deltat<0.33: # max 3 requests/second # do not touch
            time.sleep(0.33-deltat) # do not touch 
